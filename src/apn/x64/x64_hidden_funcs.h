...
extern apn_dig_t addmul_one_zen4(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t val
...
extern apn_dig_t addmul_one_x64(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t val
...
extern apn_dig_t submul_one_zen4(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t val
...
extern apn_dig_t submul_one_x64(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t val
...
extern apn_dig_t lshift_lt64_zen4(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t bit_cnt
...
extern apn_dig_t lshift_lt64_x64(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t bit_cnt
...
extern apn_dig_t rshift_lt64_zen4(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t bit_cnt
...
extern apn_dig_t rshift_lt64_x64(
	apn_dig_t* result,
	const apn_dig_t* op1,
	apn_size_t size,
	apn_dig_t bit_cnt
