...
{
    u64 blocks = size >> 5;  // Each AVX-512 register holds 8x u64, so process 32 elements per loop
    u64 remainder = size & 31;
    u64 counter = 0;

    for (u64 i = 0; i < blocks; i++)
    {
        _mm512_storeu_epi64((__m512i*)(result + counter), _mm512_loadu_epi64((const __m512i*)(op1 + counter)));
        _mm512_storeu_epi64((__m512i*)(result + counter + 8), _mm512_loadu_epi64((const __m512i*)(op1 + counter + 8)));
        _mm512_storeu_epi64((__m512i*)(result + counter + 16), _mm512_loadu_epi64((const __m512i*)(op1 + counter + 16)));
        _mm512_storeu_epi64((__m512i*)(result + counter + 24), _mm512_loadu_epi64((const __m512i*)(op1 + counter + 24)));
...
static void _avx_apn_cpy_4unroll(u64* result, const u64* op1, u64 size)
{
    ...
    for (u64 i = 0; i < blocks; i++)
    {
        _mm256_storeu_si256((__m256i*)(result + counter), _mm256_lddqu_si256((const __m256i*)(op1 + counter)));
        _mm256_storeu_si256((__m256i*)(result + counter + 4), _mm256_lddqu_si256((const __m256i*)(op1 + counter + 4)));
        _mm256_storeu_si256((__m256i*)(result + counter + 8), _mm256_lddqu_si256((const __m256i*)(op1 + counter + 8)));
        _mm256_storeu_si256((__m256i*)(result + counter + 12), _mm256_lddqu_si256((const __m256i*)(op1 + counter + 12)));
        counter += 16;
    }
