...
/*
	> Subtractive Karatsuba variant
	> Balanced multiplication
	> Uses (2*n + 32) limbs of space for size n operands
...
*/
void _apn_karatsuba_mul(u64* result, const u64* op1, const u64* op2, u64 size1, u64 size2, u64* temp);
