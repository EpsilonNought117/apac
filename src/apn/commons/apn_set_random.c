...
static inline void seed_random_sfc64(apn_dig_t seed)
{
	prng_state[0] = 1;
	prng_state[1] = seed;
	prng_state[2] = seed;
	...
	for (apn_size_t i = 0; i < (apn_size_t)16; i++){ random_sfc64(); }
